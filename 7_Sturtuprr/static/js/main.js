...
var burger = document.getElementsByClassName('header-burger')[0];
...
(0, _jquery["default"])('.slick-team').slick({
  infinite: true,
  arrows: false,
  slidesToShow: 1,
  slidesToScroll: 1,
...
(0, _jquery["default"])('.slick-quote').slick({
  infinite: true,
  arrows: false,
  slidesToShow: 1,
  slidesToScroll: 1,
...
(0, _jquery["default"])('.slick-partners').slick({
  infinite: true,
  arrows: false,
  slidesToShow: 1,
  slidesToScroll: 1,
...
console.log(_slickCarousel["default"]);
...
var icon = document.getElementsByClassName('js-item-search')[0];
...
var _asyncToGenerator2 = _interopRequireDefault(__webpack_require__(20));

var _jsFormValidator = __webpack_require__(21);

document.addEventListener('DOMContentLoaded', function () {
  var forms = Array.from(document.getElementsByClassName('js-form-ajax'));
  forms.forEach(function (form) {
    var validator = new _jsFormValidator.Validator(form, function () {
...
console.log(_jsFormValidator.Validator);
